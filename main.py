...
import sqlite3
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QLabel, QFrame, QMainWindow, QStackedWidget
...
<<<<<<< HEAD
        ...
        # self.Reminder_button.clicked.connect(self.return_clicked)
