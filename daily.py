...
"        \"\"")
        ...
        self.ani = FuncAnimation(self.pie_chart_canvas.figure, self.update_pie_chart, interval=1000)
    ...
    def update_pie_chart(self, i):
        ...
        ax.axis('equal')
        ax.set_title('Total Application Usage', pad=20)
    ...
    def get_data(self):
        ...
        # Retrieve data for today's app usage
        cursor.execute("SELECT app_name, COUNT(*) FROM timeline WHERE Day = ? GROUP BY app_name", (today,))
